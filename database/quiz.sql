...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2022 at 09:10 AM
...
(67, 'MATHS', '2022-01-28 10:48:37'),
(68, 'GENERAL KNOWLEDGE', '2022-01-28 11:40:29');
...
(9, 'test', '68', 'male', '2001-01-01', 'second year', 'test@test.com', 'test123', 'active');
...
(321, 9, 11, 30, 'sd', 'new', '2022-01-28 09:12:36'),
(322, 9, 11, 29, 'asd', 'new', '2022-01-28 09:12:36'),
(323, 9, 12, 19, 'URL (Universal Resource Locator)', 'new', '2022-01-28 09:42:53'),
(324, 9, 12, 17, 'Image file', 'new', '2022-01-28 09:42:53'),
(325, 9, 12, 10, 'File', 'new', '2022-01-28 09:42:54'),
(326, 9, 12, 22, 'Interanet', 'new', '2022-01-28 09:42:54'),
(327, 9, 12, 15, 'Steve Case & Jeff Bezos', 'new', '2022-01-28 09:42:54'),
(328, 9, 24, 32, '0', 'new', '2022-01-28 11:39:46'),
(329, 9, 24, 31, '12', 'new', '2022-01-28 11:39:46');
...
(31, 24, '10+2=', '12', '21', '22', '11', '12', 'active'),
(32, 24, '11 X 232 X 23 X 0 X 1212 X 12 + 23=', '12123', '3422335', '23234356', '0', '0', 'active'),
(33, 25, 'What is capital Of India', 'New Delhi', 'Mumbai', 'Kolkata', 'Chennai', 'New Delhi', 'active'),
(34, 25, 'What national animal of India ?', 'Lion', 'Elephant', 'Tiger', 'Bear', 'Tiger', 'active'),
(35, 25, 'India got independence in which year?', '1947', '1950', '1914', '1971', '1947', 'active');
...
(24, 67, 'Basic Maths', '10', 3, 'Simple Maths Question', '2022-01-28 11:03:03'),
(25, 68, 'India', '10', 5, 'General Knowledge Of India', '2022-01-28 11:41:42');
...
--
ALTER TABLE `course_tbl`
  MODIFY `cou_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `examinee_tbl`
--
ALTER TABLE `examinee_tbl`
  MODIFY `exmne_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `exam_answers`
--
ALTER TABLE `exam_answers`
  MODIFY `exans_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=330;

--
-- AUTO_INCREMENT for table `exam_attempt`
--
ALTER TABLE `exam_attempt`
  MODIFY `examat_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `exam_question_tbl`
--
ALTER TABLE `exam_question_tbl`
  MODIFY `eqt_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `exam_tbl`
--
ALTER TABLE `exam_tbl`
  MODIFY `ex_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `feedbacks_tbl`
--
ALTER TABLE `feedbacks_tbl`
  MODIFY `fb_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
